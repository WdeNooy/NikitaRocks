...
1. (Single level) regression model with prepared exposure variable (minutes played with someone using the gameapp in the preceding break. Inspecting output: interpreting regression coefficients (and residuals?). Demonstration with new game app adoption, additional practice with adoption of expression "wicked smaht" (every break a new episode?) ; Note: assumes constant hazard function, see Afternoon I, Part II.
...
### Morning II, Part II - Network change: Predicting sender and/or recipient
