...
2. Change the below code to inspect the other three data sets.

```{r basicdata3, exercise = TRUE}
# If you want to see a description of the data, use the help function.
# The Help information may show up in a new (browser) window.
?pupils_const
```
</div>
...
As a consequence, I have created the animated visualization the hard way, creating a snapshot of the network at every moment an event starts. The animation is just the sequence of these snapshots. 

If you want to know how, inspect the code below.

```{r calculate2, exercise=TRUE}
...
# Assumes that the basic data sets have been loaded.
