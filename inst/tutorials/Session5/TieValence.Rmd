...
* <i class="question">Other tie effect</i>: Effect of the presence or value of another relation between sender and receiver. Example: Do friends tend to receive more positive statements than pupils who are not friends?
* <i class="question">Same tie effect</i>: Effect of the presence or value of previous ties between sender and receiver on the same relation as the predicted tie. For example: Valence of the statements between Lauren and Omar in the preceding 5 minutes. If the network is directed (arcs/arrows), we distinguish between:
