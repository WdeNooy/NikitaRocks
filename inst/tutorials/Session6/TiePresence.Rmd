...
# COPY THESE COMMANDS TO THE RStudio CONSOLE AND RUN THEM THERE. 

# If you haven't installed the goldfish package yet, use the below command to
# install it from github.
remotes::install_github("snlab-ch/goldfish")

# In addition, load the NikitaRocks package in the RStudio console with the
# below command (this makes available data sets that we need).
library(NikitaRocks)
```
